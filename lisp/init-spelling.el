;;; init-spelling.el --- flyspell for checking and correcting spelling
...
(use-package flyspell
  ...
  :if (or (executable-find "aspell")
          ...
          (and (message "[Missing] You need install either aspell or hunspell for flyspell") nil))
  ...
  (when (eq ispell-program-name "hunspell")
